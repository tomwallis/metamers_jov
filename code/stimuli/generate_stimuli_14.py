...
"""Stimulus generation for experiment 14. Identical to experiment 13
with fewer patch sizes, smaller blur levels.
...
with open('generation_params_exp_14.yaml', 'r') as f:
    params = yaml.load(f)
...
out_dir = os.path.join(top_dir, 'stimuli', 'experiment-14',
                       'final_ims')
...
assigned_counter = np.zeros(1, dtype=np.int)
