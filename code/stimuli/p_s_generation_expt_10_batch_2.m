...
raw_path = [top_dir, 'stimuli/experiment-10/source_patches'];
out_path = [top_dir, 'stimuli/experiment-10/synths'];
...
start_im = 176;  % the start image for this batch
end_im = 350;  % the end image for this batch

ims = ims(start_im: end_im);


%% Parameters

n_unique = 5; % the number of unique textures to save for each original patch.
