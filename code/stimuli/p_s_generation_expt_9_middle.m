...
raw_path = [top_dir, 'stimuli/experiment-9/middle_patches'];
out_path = [top_dir, 'stimuli/experiment-9/middle_synths'];
...
n_unique = 3; % the number of unique textures to save for each original patch.
